...
declare module 'motia' {
  ...
  interface Handlers {
    ...
    'SimulateFuture': EventHandler<never, { topic: 'ai.analyze_risk'; data: never }>
    'StartMission': ApiRouteHandler<Record<string, unknown>, unknown, { topic: 'simulation.start'; data: never }>
    'ServeDashboard': ApiRouteHandler<Record<string, unknown>, unknown, never>
    'RiskAnalysisAI': EventHandler<never, { topic: 'system.patch_route'; data: never }>
  }
